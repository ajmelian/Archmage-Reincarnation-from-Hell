...
$route['market'] = 'market/index';
$route['market/my'] = 'market/my';
$route['market/create'] = 'market/create';
$route['market/buy/(:num)'] = 'market/buy/$1';
$route['market/cancel/(:num)'] = 'market/cancel/$1';
$route['auctions'] = 'auctions/index';
$route['auctions/view/(:num)'] = 'auctions/view/$1';
$route['auctions/create'] = 'auctions/create';
$route['auctions/bid/(:num)'] = 'auctions/bid/$1';
$route['auctions/cancel/(:num)'] = 'auctions/cancel/$1';
$route['api/v1/market/listings'] = 'api/v1/market_listings';
$route['api/v1/market/list'] = 'api/v1/market_list';
$route['api/v1/market/buy'] = 'api/v1/market_buy';
$route['api/v1/auctions/active'] = 'api/v1/auctions_active';
$route['api/v1/auctions/create'] = 'api/v1/auctions_create';
$route['api/v1/auctions/bid'] = 'api/v1/auctions_bid';
$route['marketcli/expire'] = 'marketcli/expire';

$route['alliances'] = 'alliances/index';
$route['alliances/create'] = 'alliances/create';
$route['alliances/invite'] = 'alliances/invite';
$route['alliances/accept/(:num)'] = 'alliances/accept/$1';
$route['alliances/leave'] = 'alliances/leave';
$route['alliances/promote'] = 'alliances/promote';
$route['alliances/demote'] = 'alliances/demote';
$route['alliances/kick'] = 'alliances/kick';
$route['api/v1/alliance/me'] = 'api/v1/alliance_me';
$route['api/v1/alliance/create'] = 'api/v1/alliance_create';
$route['api/v1/alliance/invite'] = 'api/v1/alliance_invite';
$route['api/v1/alliance/accept'] = 'api/v1/alliance_accept';
$route['api/v1/alliance/leave'] = 'api/v1/alliance_leave';
